function [id_to_bpm_x, id_to_cm_x, id_to_bpm_y, id_to_cm_y] = diamond_I_configuration_v5(RMorigx,RMorigy,square_config)
if nargin < 3
    square_config = false;
end
...
if ~square_config
    bad_bpm_x = [32  75  78 120 137 155]+1;
    bad_bpm_y = [18  25  62  75  78  83 137 141]+1;
    bad_cm_x = [76]+1;
    bad_cm_y = [76]+1;
else
    bad_bpm_x = [32  75  78 120 137 155]+1;
    ...
    bad_cm_x = [76 32 120 137 155]+1;
    bad_cm_y = [76 18 25 62 83 137 141]+1;
end
bad_bpm_x = sort(bad_bpm_x,'asc');
bad_bpm_y = sort(bad_bpm_y,'asc');
bad_cm_x = sort(bad_cm_x,'asc');
bad_cm_y = sort(bad_cm_y,'asc');
