function [y_sim,u_sim,x_sim] = sim_mpc_convergence_fast(...
...
for k = 1:1:n_samples
    ...
    if k > n_delay
        ...
        if use_qp
            ...
            sol_qp = quadprog(JJ,q_qp,[],[],[],[],double(lower_u),double(upper_u),double(u_sim(id_to_cm,k-1)),...
                optimset('Display', 'off'));
            fgm_result = single(sol_qp);
        else
