function [y_sim,u_sim,...
    ...
    fgm_x0,fgm_xd,fgm_u,fgm_out,lower_u,upper_u] = sim_mpc_w_LQR_obsv(...
            n_samples, n_delay, dist,...
            Ap, Bp, Cp,... % Plant
            Ao, Bo, Co, Kf,... % Observer
...
for k = 1:1:n_samples
    ...
    if k > n_delay
        ...
        x_pre = Ao * x_post + Bo * u_sim(id_to_cm,k-1);
        x0_obs_new = x_post(1:165);
        xd_obs_new = x_post(end-165+1:end);
