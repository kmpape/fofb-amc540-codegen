...
% Recording of the failing full IMC. Beginning of data can be used as doff
...
y = data_FA.y;
u = data_FA.u;
indfofbstart = 86630; % first nonzero fofb input, associated y is at 86630-1
clear data_FA
...
figure;
plot(1:172, usimend, 'b'); hold on;
plot(1:172, uend, 'r'); hold on;
title('Steady State Gain');
